...
export function SignupForm({
  ...
  // Guardam os dados digitados e o status de carregamento
  ...
  async function handleSubmit(event: React.FormEvent) {
    ...
    // Verifica validação mínima de tamanho
    ...
    if (password !== confirmPassword) {
      toast.error("Senhas diferentes", {
        description: "A senha e a confirmação não batem. Tente novamente."
      })
      return
    }
                ...
                <Field className="grid grid-cols-2 gap-4">
                  ...
                  <Field>
                    ...
                    <Input 
                      ...
                      required
                      minLength={8}
                      // Liga o input à variável confirmPassword
